...
/**
 * GoalCardQuarterly - Design EXACT du wireframe
 * 
 * WIREFRAME SPECS (observé dans Image 3):
 * - Header: Icône + Titre + Menu
 * - Contexte hiérarchique: "Q1 - 25% de 700k annuel"
 * - Progress bar avec badge status
 * - Deadline inline avec emoji: "📅 Deadline: 31 mars 2026"
...
function GoalCardQuarterly({ goal, onMenuClick }) {
  // Icônes de catégorie
    ...
    >
      ...
      {goal.deadline && (
        ...
        >
          ...
          <span>
            <span style={{ color: '#8BA3B8' }}>Deadline: </span>
            <span style={{ color: '#E8F1F5', fontWeight: 600 }}>
...
export default GoalCardQuarterly